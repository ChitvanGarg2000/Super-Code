    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#3846CE] flex items-center gap-2">
                <Plus size={24} className="text-[#3846CE]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-[#3846CE]  shadow-[0_0_0_1px_#3846CE,0_8px_20px_rgba(56, 70, 206, 0.15)]"
                              : "hover:border-[#3846CE] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }`}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#3846CE] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#3846CE] hover:bg-[#6C63FF]"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#3846CE]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#3846CE,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#3846CE]" />
